$PBExportHeader$w_com_baja_mat.srw
$PBExportComments$Ventana utilizada para capturar la baja del material
forward
global type w_com_baja_mat from window
end type
type dw_baja_mat from datawindow within w_com_baja_mat
end type
type cb_2 from commandbutton within w_com_baja_mat
end type
type cb_1 from commandbutton within w_com_baja_mat
end type
end forward
...
global w_com_baja_mat w_com_baja_mat

on w_com_baja_mat.create
