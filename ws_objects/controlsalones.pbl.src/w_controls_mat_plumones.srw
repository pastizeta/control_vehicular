$PBExportHeader$w_controls_mat_plumones.srw
forward
global type w_controls_mat_plumones from window
end type
type rb_3 from radiobutton within w_controls_mat_plumones
end type
type st_4 from statictext within w_controls_mat_plumones
end type
type cb_4 from commandbutton within w_controls_mat_plumones
end type
type rb_2 from radiobutton within w_controls_mat_plumones
end type
type rb_1 from radiobutton within w_controls_mat_plumones
end type
type cb_3 from commandbutton within w_controls_mat_plumones
end type
type cb_2 from commandbutton within w_controls_mat_plumones
end type
type st_3 from statictext within w_controls_mat_plumones
end type
type st_2 from statictext within w_controls_mat_plumones
end type
type sle_nombreprof from singlelineedit within w_controls_mat_plumones
end type
type sle_cuenta from singlelineedit within w_controls_mat_plumones
end type
type st_1 from statictext within w_controls_mat_plumones
end type
type dw_consulta from datawindow within w_controls_mat_plumones
end type
type cbx_2 from checkbox within w_controls_mat_plumones
end type
type cbx_1 from checkbox within w_controls_mat_plumones
end type
type cb_1 from commandbutton within w_controls_mat_plumones
end type
type gb_1 from groupbox within w_controls_mat_plumones
end type
end forward
...
global w_controls_mat_plumones w_controls_mat_plumones
...
on w_controls_mat_plumones.create
...
on w_controls_mat_plumones.destroy
destroy(this.rb_3)
destroy(this.st_4)
destroy(this.cb_4)
destroy(this.rb_2)
...
integer taborder = 20
string title = "none"
string dataobject = "d_controls_mat_plumones"
...
event clicked;
if trim(sle_cuenta.text) <>"" then
	dw_consulta.dataobject='d_controls_mat_plumones'
	dw_consulta.settransobject(gtr_sumuia)
...
elseif (cbx_1.checked and rb_3.checked) or( cbx_2.checked and rb_3.checked) then
	dw_consulta.dataobject='d_controls_mat_plumones_todos'
	dw_consulta.settransobject(gtr_sumuia)
	dw_consulta.Retrieve(ii_estatus)
	if ii_estatus = 3 then
		dw_consulta.object.t_2.text = 'Reporte de Plumnos a Cambio'
	end if
else
