$PBExportHeader$w_controls_reporte_matprestamo_ant.srw
forward
global type w_controls_reporte_matprestamo_ant from w_sheet
end type
type st_5 from statictext within w_controls_reporte_matprestamo_ant
end type
type st_4 from statictext within w_controls_reporte_matprestamo_ant
end type
type st_3 from statictext within w_controls_reporte_matprestamo_ant
end type
type em_dos from editmask within w_controls_reporte_matprestamo_ant
end type
type em_uno from editmask within w_controls_reporte_matprestamo_ant
end type
type cbx_dosperiodos from checkbox within w_controls_reporte_matprestamo_ant
end type
type st_2 from statictext within w_controls_reporte_matprestamo_ant
end type
type cb_4 from commandbutton within w_controls_reporte_matprestamo_ant
end type
type em_clave from editmask within w_controls_reporte_matprestamo_ant
end type
type em_inter from editmask within w_controls_reporte_matprestamo_ant
end type
type cbx_clave from checkbox within w_controls_reporte_matprestamo_ant
end type
type cbx_inter from checkbox within w_controls_reporte_matprestamo_ant
end type
type cb_3 from commandbutton within w_controls_reporte_matprestamo_ant
end type
type dw_depto from datawindow within w_controls_reporte_matprestamo_ant
end type
type cb_2 from commandbutton within w_controls_reporte_matprestamo_ant
end type
type cbx_bus from checkbox within w_controls_reporte_matprestamo_ant
end type
type dw_busqueda from datawindow within w_controls_reporte_matprestamo_ant
end type
type dw_fecha from datawindow within w_controls_reporte_matprestamo_ant
end type
type dw_reporte from datawindow within w_controls_reporte_matprestamo_ant
end type
type cb_1 from commandbutton within w_controls_reporte_matprestamo_ant
end type
type cbx_material from checkbox within w_controls_reporte_matprestamo_ant
end type
type st_1 from statictext within w_controls_reporte_matprestamo_ant
end type
type em_fecha_fin from editmask within w_controls_reporte_matprestamo_ant
end type
type cbx_fecha from checkbox within w_controls_reporte_matprestamo_ant
end type
type cbx_cuenta from checkbox within w_controls_reporte_matprestamo_ant
end type
type dw_desc from datawindow within w_controls_reporte_matprestamo_ant
end type
type em_cuenta from editmask within w_controls_reporte_matprestamo_ant
end type
type gb_1 from groupbox within w_controls_reporte_matprestamo_ant
end type
type gb_2 from groupbox within w_controls_reporte_matprestamo_ant
end type
type gb_3 from groupbox within w_controls_reporte_matprestamo_ant
end type
type gb_5 from groupbox within w_controls_reporte_matprestamo_ant
end type
end forward
...
global w_controls_reporte_matprestamo_ant w_controls_reporte_matprestamo_ant
...
on w_controls_reporte_matprestamo_ant.create
int iCurrent
call super::create
...
on w_controls_reporte_matprestamo_ant.destroy
call super::destroy
destroy(this.st_5)
destroy(this.st_4)
destroy(this.st_3)
...
event clicked;if this.checked then
	...
	dw_reporte.dataobject = "d_controls_rep_materialfecha_dos"
...
event clicked;if this.checked then
	...
	em_cuenta.enabled = false
	em_fecha_fin.text = string(datetime(idtm_fecha),"dd/mm/yyyy")
	dw_reporte.dataobject = "d_controls_rep_materialcta" 
	dw_reporte.SettransObject(gtr_sumuia)
end if
end event
...
integer taborder = 40
string title = "none"
string dataobject = "d_controls_rep_materialcta"
...
elseif cbx_fecha.checked and cbx_dosperiodos.checked then
	if isdate(em_uno.text) Then
		...
		dw_reporte.dataobject = "d_controls_rep_materialfecha_dos"
		dw_reporte.SettransObject(gtr_sumuia)
		dw_reporte.retrieve(ld_Fecha,ld_Fecha2)
		dw_reporte.object.t_depto.text = is_departamento
		st_4.visible = false
	else
...
event clicked;if this.checked then
	...
	dw_desc.setfocus()
	em_fecha_fin.text = string(datetime(idtm_fecha),"dd/mm/yyyy")
	dw_reporte.dataobject = "d_controls_rep_materialdesc"
	dw_reporte.SettransObject(gtr_sumuia)
end if
end event
