$PBExportHeader$w_gral_busca_empleados.srw
$PBExportComments$Permite buscar alumnos y empleados
forward
global type w_gral_busca_empleados from w_sheet
end type
type dw_1 from u_dw within w_gral_busca_empleados
end type
type cb_1 from commandbutton within w_gral_busca_empleados
end type
type st_3 from statictext within w_gral_busca_empleados
end type
type st_2 from statictext within w_gral_busca_empleados
end type
type st_1 from statictext within w_gral_busca_empleados
end type
type sle_nombre from singlelineedit within w_gral_busca_empleados
end type
type sle_amaterno from singlelineedit within w_gral_busca_empleados
end type
type sle_apaterno from singlelineedit within w_gral_busca_empleados
end type
type rb_2 from radiobutton within w_gral_busca_empleados
end type
type gb_1 from groupbox within w_gral_busca_empleados
end type
end forward
...
global w_gral_busca_empleados w_gral_busca_empleados
...
on w_gral_busca_empleados.create
int iCurrent
call super::create
...
on w_gral_busca_empleados.destroy
call super::destroy
destroy(this.dw_1)
destroy(this.cb_1)
destroy(this.st_3)
...
if ib_selecciona then
	regreso.ii_parm1 = 1
	CloseWithReturn(w_gral_busca_empleados,regreso)
else
	regreso.ii_parm1 = 0
	CloseWithReturn(w_gral_busca_empleados,regreso)
...
integer height = 1648
integer taborder = 50
string dataobject = "d_esp_gral_busca_empleados"
...
//////////////////////////////////////////////////////////////////////////////
	...
	choose case iiselAlmEmpl
		case 2
			...
			llDeptoCarrera = long(dw_1.GetItemnumber(row,'estructura_nomina_responsable'))
	end choose
...
regreso.ii_parm2 = 2
dw_1.dataobject = "d_esp_gral_busca_empleados"
