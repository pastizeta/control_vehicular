$PBExportHeader$w_ccd_consulta_espacio_imprime.srw
forward
global type w_ccd_consulta_espacio_imprime from window
end type
type cb_imprime from commandbutton within w_ccd_consulta_espacio_imprime
end type
type cb_exporta from commandbutton within w_ccd_consulta_espacio_imprime
end type
type dw_imprime from datawindow within w_ccd_consulta_espacio_imprime
end type
type dw_exporta from datawindow within w_ccd_consulta_espacio_imprime
end type
type dw_datos from datawindow within w_ccd_consulta_espacio_imprime
end type
end forward
...
global w_ccd_consulta_espacio_imprime w_ccd_consulta_espacio_imprime
...
on w_ccd_consulta_espacio_imprime.create
...
on w_ccd_consulta_espacio_imprime.destroy
...
integer taborder = 10
string title = "none"
string dataobject = "d_ccd_cal_prestamo_print_dia"
