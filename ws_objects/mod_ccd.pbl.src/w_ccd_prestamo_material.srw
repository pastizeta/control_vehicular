$PBExportHeader$w_ccd_prestamo_material.srw
forward
global type w_ccd_prestamo_material from window
end type
type ole_1 from olecustomcontrol within w_ccd_prestamo_material
end type
type cbx_espacio from checkbox within w_ccd_prestamo_material
end type
type cbx_venta from checkbox within w_ccd_prestamo_material
end type
type dw_tipo_usuario from datawindow within w_ccd_prestamo_material
end type
type st_1 from statictext within w_ccd_prestamo_material
end type
type tab_solicitud from tab within w_ccd_prestamo_material
end type
...
type st_cod_uia from statictext within w_ccd_prestamo_material
end type
type dw_reporte_mat from datawindow within w_ccd_prestamo_material
end type
type sle_cod_agregar from singlelineedit within w_ccd_prestamo_material
end type
type dw_matgrupo from u_basedw within w_ccd_prestamo_material
end type
type dw_grupomat from u_basedw within w_ccd_prestamo_material
end type
type st_grupo from statictext within w_ccd_prestamo_material
end type
type cb_cerrar from commandbutton within w_ccd_prestamo_material
end type
type dw_disponible from datawindow within w_ccd_prestamo_material
end type
type cb_buscar from commandbutton within w_ccd_prestamo_material
end type
type st_material from statictext within w_ccd_prestamo_material
end type
type st_3 from statictext within w_ccd_prestamo_material
end type
type st_2 from statictext within w_ccd_prestamo_material
end type
type em_hora_final from editmask within w_ccd_prestamo_material
end type
type em_fecha_final from editmask within w_ccd_prestamo_material
end type
type st_final from statictext within w_ccd_prestamo_material
end type
type em_hora_inicio from editmask within w_ccd_prestamo_material
end type
type em_fecha_inicio from editmask within w_ccd_prestamo_material
end type
type st_inicio from statictext within w_ccd_prestamo_material
end type
type dw_solicitante from datawindow within w_ccd_prestamo_material
end type
type cb_materias from commandbutton within w_ccd_prestamo_material
end type
type dw_foto from datawindow within w_ccd_prestamo_material
end type
type st_cuenta from statictext within w_ccd_prestamo_material
end type
type sle_solicitante from singlelineedit within w_ccd_prestamo_material
end type
type gb_busqueda from groupbox within w_ccd_prestamo_material
end type
type gb_solicitud from groupbox within w_ccd_prestamo_material
end type
type gb_material from groupbox within w_ccd_prestamo_material
end type
type gb_seleccionado from groupbox within w_ccd_prestamo_material
end type
type gb_disponible from groupbox within w_ccd_prestamo_material
end type
type gb_solicitante from groupbox within w_ccd_prestamo_material
end type
type dw_inventario_disponible from datawindow within w_ccd_prestamo_material
end type
type cb_generar from commandbutton within w_ccd_prestamo_material
end type
end forward
...
string title = "Préstamo de Materiales CCD"
...
global w_ccd_prestamo_material w_ccd_prestamo_material
...
if ii_modal=1 then 
	//Venta
	this.title='Venta de Materiales CCD' 
	...
	if ii_modal=0 then
		this.title='Préstamo de Materiales CCD'
		idwc_grupomat.SetFilter('cvegrupo<>6')
	else
		this.title='Préstamo de Espacios CCD' 
		idwc_grupomat.SetFilter('cvegrupo=6')
	end if
...
if ii_modal=0 then openwithparm(w_ccd_solicitudes_hoy,lstr_sol_material)
if ii_modal=2 then openwithparm(w_ccd_solicitudes_espacios,lstr_sol_material)
...
this.title='Préstamo de Materiales CCD [Folio: '+string(p_folio)+']'
...
on w_ccd_prestamo_material.create
...
on w_ccd_prestamo_material.destroy
destroy(this.ole_1)
...
string binarykey = "w_ccd_prestamo_material.win"
integer textsize = -10
integer weight = 400
			...
			if this.GetItemNumber(row,'tipo_unidad')=1 then
				...
				if li_existe>0 then
					...
					if li_disponible>1 then
						...
						openwithparm(w_ccd_prestamo_cantidad,li_disponible)
...
if trim(this.text)<>'' then
	...
	if li_existe>0 then
		...
		if li_disponible>0 then
			...
			openwithparm(w_ccd_entrega_cantidad,li_disponible)
...
0Fw_ccd_prestamo_material.bin 

