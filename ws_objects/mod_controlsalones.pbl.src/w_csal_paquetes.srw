$PBExportHeader$w_csal_paquetes.srw
forward
global type w_csal_paquetes from w_modelo_cap
end type
end forward
...
global w_csal_paquetes w_csal_paquetes

type variables
integer  ii_gpo_mat
end variables

on w_csal_paquetes.create
call super::create
end on

on w_csal_paquetes.destroy
call super::destroy
end on
...
type dw_motivo from w_modelo_cap`dw_motivo within w_csal_paquetes
end type

type cb_actualiza from w_modelo_cap`cb_actualiza within w_csal_paquetes
integer x = 1422
integer y = 900
end type

type cb_cerrar from w_modelo_cap`cb_cerrar within w_csal_paquetes
integer x = 1824
integer y = 900
end type

type cb_eliminar from w_modelo_cap`cb_eliminar within w_csal_paquetes
integer x = 1019
integer y = 900
end type

type cb_nuevo from w_modelo_cap`cb_nuevo within w_csal_paquetes
integer x = 617
integer y = 900
end type
...
type dw_cap from w_modelo_cap`dw_cap within w_csal_paquetes
integer width = 2693
integer height = 804
string dataobject = "d_csal_paquetes_mat"
end type
