$PBExportHeader$w_veh_cat_motivos_rechazo_edita.srw
forward
global type w_veh_cat_motivos_rechazo_edita from window
end type
type cb_eliminar from commandbutton within w_veh_cat_motivos_rechazo_edita
end type
type mle_descripcion from multilineedit within w_veh_cat_motivos_rechazo_edita
end type
type cb_guardar from commandbutton within w_veh_cat_motivos_rechazo_edita
end type
type gb_titulo from groupbox within w_veh_cat_motivos_rechazo_edita
end type
end forward
...
string title = "Motivo de rechazo"
...
global w_veh_cat_motivos_rechazo_edita w_veh_cat_motivos_rechazo_edita
...
into :ll_id
from dbo.via_cat_motivos_rechazo
using gtr_cv; 
...
on w_veh_cat_motivos_rechazo_edita.create
...
on w_veh_cat_motivos_rechazo_edita.destroy
...
ids_catalogo.dataobject ='d_veh_cat_motivos_rechazo_edit'
...
CloseWithReturn(w_veh_cat_motivos_rechazo_edita,0)
...
string facename = "Verdana"
long backcolor = 30520472
string text = "Edición de motivo de rechazo"
end type
