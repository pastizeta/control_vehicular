$PBExportHeader$w_veh_solicitudes_internas_reportes.srw
forward
global type w_veh_solicitudes_internas_reportes from window
end type
type st_5 from statictext within w_veh_solicitudes_internas_reportes
end type
type em_fecha_inicio from editmask within w_veh_solicitudes_internas_reportes
end type
type dw_cat_estatus_solicitud from datawindow within w_veh_solicitudes_internas_reportes
end type
type cb_filtros from commandbutton within w_veh_solicitudes_internas_reportes
end type
type gb_filtros from groupbox within w_veh_solicitudes_internas_reportes
end type
type dw_solicitudes from datawindow within w_veh_solicitudes_internas_reportes
end type
type gb_titulo from groupbox within w_veh_solicitudes_internas_reportes
end type
type st_1 from statictext within w_veh_solicitudes_internas_reportes
end type
type sle_sol_id from singlelineedit within w_veh_solicitudes_internas_reportes
end type
type st_4 from statictext within w_veh_solicitudes_internas_reportes
end type
end forward
...
global w_veh_solicitudes_internas_reportes w_veh_solicitudes_internas_reportes
...
on w_veh_solicitudes_internas_reportes.create
...
on w_veh_solicitudes_internas_reportes.destroy
destroy(this.st_5)
...
integer taborder = 60
string title = "none"
string dataobject = "d_veh_solicitudes_adm_reporte"
...
if row>0 then
	...
	if isvalid(w_veh_solicitud_interna_reporte) then close(w_veh_solicitud_interna_reporte) 
	ll_id=this.GetItemNumber(row,'sol_id')
	openwithparm(w_veh_solicitud_interna_reporte,ll_id)
