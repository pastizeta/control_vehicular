$PBExportHeader$w_cor_agregar_lista_espera.srw
forward
global type w_cor_agregar_lista_espera from window
end type
type ole_1 from olecustomcontrol within w_cor_agregar_lista_espera
end type
type mle_nombre from multilineedit within w_cor_agregar_lista_espera
end type
type dw_tipo_usuario from datawindow within w_cor_agregar_lista_espera
end type
type cb_agregar from commandbutton within w_cor_agregar_lista_espera
end type
type st_final from statictext within w_cor_agregar_lista_espera
end type
type st_inicio from statictext within w_cor_agregar_lista_espera
end type
type em_fecha_inicio from editmask within w_cor_agregar_lista_espera
end type
type em_fecha_final from editmask within w_cor_agregar_lista_espera
end type
type st_3 from statictext within w_cor_agregar_lista_espera
end type
type st_2 from statictext within w_cor_agregar_lista_espera
end type
type em_hora_inicio from editmask within w_cor_agregar_lista_espera
end type
type em_hora_final from editmask within w_cor_agregar_lista_espera
end type
type st_cuenta from statictext within w_cor_agregar_lista_espera
end type
type sle_solicitante from singlelineedit within w_cor_agregar_lista_espera
end type
end forward
...
global w_cor_agregar_lista_espera w_cor_agregar_lista_espera
...
public function integer f_valida_acceso ();integer li_acceso=-1, li_row, li_materiales, NET, li_suspendido=0, li_reservados, li_prestamo=0, li_espera=0
integer li_presolicitado=0
...
if li_acceso=0 then
	...
	//Validar que en ese lapso no esté prestado, en presolicitud ni en lista de espera
	li_prestamo=f_valida_prestamos_usuario_fecha(il_solicitante,gi_depto,ii_cvearea,ii_tipo_usuario,idt_fecha_inicio,idt_fecha_final,1)
	if li_prestamo>0 then
		messagebox('Aviso','El usuario ya tiene una reservación activa en ese lapso.')
		return -1
	end if
	li_presolicitado=f_valida_prestamos_usuario_fecha(il_solicitante,gi_depto,ii_cvearea,ii_tipo_usuario,idt_fecha_inicio,idt_fecha_final,0)
	if li_presolicitado>0 then
		messagebox('Aviso','El usuario ya tiene una presolicitud activa en ese lapso.')
		return -1
	end if
	li_espera=f_valida_prestamos_usuario_fecha(il_solicitante,gi_depto,ii_cvearea,ii_tipo_usuario,idt_fecha_inicio,idt_fecha_final,-1)
	if li_espera>0 then
		messagebox('Aviso','El usuario ya tiene un registro en lista de espera en ese lapso.')
		return -1
	end if
...
on w_cor_agregar_lista_espera.create
...
on w_cor_agregar_lista_espera.destroy
destroy(this.ole_1)
...
string binarykey = "w_cor_agregar_lista_espera.win"
integer textsize = -10
integer weight = 400
...
if Net=1 then
	...
	w_cor_control_prestamo.uf_cargar()
	close(w_cor_agregar_lista_espera)
...
04w_cor_agregar_lista_espera.bin 

14w_cor_agregar_lista_espera.bin 
