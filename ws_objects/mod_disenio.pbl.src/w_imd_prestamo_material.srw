$PBExportHeader$w_imd_prestamo_material.srw
forward
global type w_imd_prestamo_material from window
end type
type dw_tipo_usuario from datawindow within w_imd_prestamo_material
end type
type cb_espera from commandbutton within w_imd_prestamo_material
end type
type dw_foro from u_basedw within w_imd_prestamo_material
end type
type st_foro from statictext within w_imd_prestamo_material
end type
type ole_1 from olecustomcontrol within w_imd_prestamo_material
end type
type tab_solicitud from tab within w_imd_prestamo_material
end type
...
type st_cod_uia from statictext within w_imd_prestamo_material
end type
type dw_reporte_mat from datawindow within w_imd_prestamo_material
end type
type sle_cod_agregar from singlelineedit within w_imd_prestamo_material
end type
type dw_matgrupo from u_basedw within w_imd_prestamo_material
end type
type dw_grupomat from u_basedw within w_imd_prestamo_material
end type
type st_grupo from statictext within w_imd_prestamo_material
end type
type cb_cerrar from commandbutton within w_imd_prestamo_material
end type
type cb_generar from commandbutton within w_imd_prestamo_material
end type
type dw_disponible from datawindow within w_imd_prestamo_material
end type
type cb_buscar from commandbutton within w_imd_prestamo_material
end type
type st_material from statictext within w_imd_prestamo_material
end type
type st_3 from statictext within w_imd_prestamo_material
end type
type st_2 from statictext within w_imd_prestamo_material
end type
type em_hora_final from editmask within w_imd_prestamo_material
end type
type em_fecha_final from editmask within w_imd_prestamo_material
end type
type st_final from statictext within w_imd_prestamo_material
end type
type em_hora_inicio from editmask within w_imd_prestamo_material
end type
type em_fecha_inicio from editmask within w_imd_prestamo_material
end type
type st_inicio from statictext within w_imd_prestamo_material
end type
type dw_solicitante from datawindow within w_imd_prestamo_material
end type
type cb_materias from commandbutton within w_imd_prestamo_material
end type
type dw_foto from datawindow within w_imd_prestamo_material
end type
type st_cuenta from statictext within w_imd_prestamo_material
end type
type sle_solicitante from singlelineedit within w_imd_prestamo_material
end type
type gb_busqueda from groupbox within w_imd_prestamo_material
end type
type gb_solicitud from groupbox within w_imd_prestamo_material
end type
type gb_material from groupbox within w_imd_prestamo_material
end type
type gb_seleccionado from groupbox within w_imd_prestamo_material
end type
type gb_disponible from groupbox within w_imd_prestamo_material
end type
type gb_agregar from groupbox within w_imd_prestamo_material
end type
type gb_solicitante from groupbox within w_imd_prestamo_material
end type
type dw_inventario_disponible from datawindow within w_imd_prestamo_material
end type
end forward
...
global w_imd_prestamo_material w_imd_prestamo_material
...
if il_folio_espera>0 then
	...
	update dbo.spre_pre_solicitud
	set status=2
	where cvedepto=:gi_depto and folio=:il_folio_espera
	using gtr_sumuia;
	...
	if gtr_sumuia.SQLCode = -1 then 
		messagebox("Error SUMUIA: Actualizar status de Lista de Espera", gtr_sumuia.SQLErrText)	
		rollback using gtr_sumuia;
	else
		commit using gtr_sumuia;	
	end if	
...
public subroutine f_activar_controles ();string ls_filtrof='', ls_filtrog=''
	...
	//dw_inventario_disponible.Retrieve(gi_depto,ii_cvearea,idt_fecha_inicio,idt_fecha_final)
end subroutine
...
if li_acceso=0 then
	...
	li_materiales= f_valida_prestamos_usuario(il_solicitante,gi_depto,ii_cvearea,ii_tipo_usuario)
...
choose case ii_tipo_carga
	...
	case 2
		...
		if ii_expira=1 then
			messagebox('Aviso','Esta solicitud ya expiró, sólo podrá entregar material.')
		else
			f_activar_controles()
		end if
...
on w_imd_prestamo_material.create
...
on w_imd_prestamo_material.destroy
...
if IsValid(w_imd_control_prestamo) then 	w_imd_control_prestamo.uf_cargar()
...
if lstr_pres_control.folio_presol>0 then
	...
	if li_valida=-1 then
		...
		if lstr_folios.folio_solicitud>0 then
			messagebox('Aviso','3El material nuevo se cargará a la solicitud activa con Folio: '+string(lstr_folios.folio_solicitud)+'.')
...
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
string binarykey = "w_imd_prestamo_material.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
event clicked;close(w_imd_prestamo_material)
end event
...
0Fw_imd_prestamo_material.bin 

