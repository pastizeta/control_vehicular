$PBExportHeader$w_gen_prestamo_material.srw
forward
global type w_gen_prestamo_material from window
end type
type ole_1 from olecustomcontrol within w_gen_prestamo_material
end type
type dw_tipo_usuario from datawindow within w_gen_prestamo_material
end type
type st_cod_uia from statictext within w_gen_prestamo_material
end type
type dw_reporte_mat from datawindow within w_gen_prestamo_material
end type
type sle_cod_uia from singlelineedit within w_gen_prestamo_material
end type
type cbx_todos from checkbox within w_gen_prestamo_material
end type
type dw_matgrupo from u_basedw within w_gen_prestamo_material
end type
type dw_grupomat from u_basedw within w_gen_prestamo_material
end type
type st_1 from statictext within w_gen_prestamo_material
end type
type cb_salir from commandbutton within w_gen_prestamo_material
end type
type dw_solicitados from datawindow within w_gen_prestamo_material
end type
type cb_generar from commandbutton within w_gen_prestamo_material
end type
type cb_eliminar from commandbutton within w_gen_prestamo_material
end type
type dw_disponible from datawindow within w_gen_prestamo_material
end type
type cb_buscar from commandbutton within w_gen_prestamo_material
end type
type st_5 from statictext within w_gen_prestamo_material
end type
type st_4 from statictext within w_gen_prestamo_material
end type
type st_3 from statictext within w_gen_prestamo_material
end type
type st_2 from statictext within w_gen_prestamo_material
end type
type em_hora_final from editmask within w_gen_prestamo_material
end type
type em_fecha_final from editmask within w_gen_prestamo_material
end type
type st_final from statictext within w_gen_prestamo_material
end type
type em_hora_inicio from editmask within w_gen_prestamo_material
end type
type em_fecha_inicio from editmask within w_gen_prestamo_material
end type
type st_inicio from statictext within w_gen_prestamo_material
end type
type dw_solicitante from datawindow within w_gen_prestamo_material
end type
type cb_materias from commandbutton within w_gen_prestamo_material
end type
type dw_foto from datawindow within w_gen_prestamo_material
end type
type st_cuenta from statictext within w_gen_prestamo_material
end type
type sle_solicitante from singlelineedit within w_gen_prestamo_material
end type
type gb_busqueda from groupbox within w_gen_prestamo_material
end type
type gb_solicitante from groupbox within w_gen_prestamo_material
end type
type gb_solicitud from groupbox within w_gen_prestamo_material
end type
type gb_material from groupbox within w_gen_prestamo_material
end type
type gb_seleccionado from groupbox within w_gen_prestamo_material
end type
type gb_disponible from groupbox within w_gen_prestamo_material
end type
type dw_inventario_disponible from datawindow within w_gen_prestamo_material
end type
end forward
...
string title = "Préstamo de Materiales"
...
global w_gen_prestamo_material w_gen_prestamo_material
...
on w_gen_prestamo_material.create
...
on w_gen_prestamo_material.destroy
destroy(this.ole_1)
...
string binarykey = "w_gen_prestamo_material.win"
integer textsize = -10
integer weight = 400
...
event clicked;close(w_gen_prestamo_material)
end event
...
0Fw_gen_prestamo_material.bin 

