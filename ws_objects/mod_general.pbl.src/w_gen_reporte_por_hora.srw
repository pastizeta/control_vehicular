$PBExportHeader$w_gen_reporte_por_hora.srw
forward
global type w_gen_reporte_por_hora from window
end type
type dw_mes from u_basedw within w_gen_reporte_por_hora
end type
type ddlb_anio_mes from dropdownlistbox within w_gen_reporte_por_hora
end type
type rb_mes from radiobutton within w_gen_reporte_por_hora
end type
type ddlb_reserva from dropdownlistbox within w_gen_reporte_por_hora
end type
type st_tipo from statictext within w_gen_reporte_por_hora
end type
type cb_exporta from commandbutton within w_gen_reporte_por_hora
end type
type cb_imprime from commandbutton within w_gen_reporte_por_hora
end type
type dw_semana from u_basedw within w_gen_reporte_por_hora
end type
type st_grupo from statictext within w_gen_reporte_por_hora
end type
type ddlb_anio_semana from dropdownlistbox within w_gen_reporte_por_hora
end type
type ddlb_anio_periodo from dropdownlistbox within w_gen_reporte_por_hora
end type
type rb_periodo from radiobutton within w_gen_reporte_por_hora
end type
type ddlb_periodo from dropdownlistbox within w_gen_reporte_por_hora
end type
type st_periodo from statictext within w_gen_reporte_por_hora
end type
type cb_buscar from commandbutton within w_gen_reporte_por_hora
end type
type em_fecha1 from editmask within w_gen_reporte_por_hora
end type
type rb_semana from radiobutton within w_gen_reporte_por_hora
end type
type rb_dia from radiobutton within w_gen_reporte_por_hora
end type
type dw_material from u_basedw within w_gen_reporte_por_hora
end type
type dw_grupo from u_basedw within w_gen_reporte_por_hora
end type
type dw_carga from datawindow within w_gen_reporte_por_hora
end type
type dw_datos from datawindow within w_gen_reporte_por_hora
end type
type gb_1 from groupbox within w_gen_reporte_por_hora
end type
end forward
...
string title = "Reporte de préstamos por hora"
...
global w_gen_reporte_por_hora w_gen_reporte_por_hora
...
public subroutine uf_carga ();integer  li_i=1, li_grupo=0, li_grupo_ant=0, li_renglon=0
string ls_material='',ls_material_ant='',ls_descripcion,ls_hora='', ls_lapso, ls_titulo, ls_nom_mes
...
if ii_grupo=-1 then
	dw_datos.DataObject='d_gen_tab_grupo_conteo_hora'
	...
	for li_i=1 to dw_datos.RowCount()
		...
		ls_hora=dw_datos.GetItemString(li_i,'hora_alta')
		...
		choose case ls_hora
			case '00','01','02','03','04','05','06'
				li_pres_antes=li_pres_antes+li_prestamos
				dw_carga.SetItem(li_renglon,'p_0',li_prestamos)
			case '07'
				dw_carga.SetItem(li_renglon,'p_7',li_prestamos)
			case '08'
				dw_carga.SetItem(li_renglon,'p_8',li_prestamos)
			case '09'
				dw_carga.SetItem(li_renglon,'p_9',li_prestamos)
			case '10'
				dw_carga.SetItem(li_renglon,'p_10',li_prestamos)
			case '11'
				dw_carga.SetItem(li_renglon,'p_11',li_prestamos)
			case '12'
				dw_carga.SetItem(li_renglon,'p_12',li_prestamos)
			case '13'
				dw_carga.SetItem(li_renglon,'p_13',li_prestamos)
			case '14'
				dw_carga.SetItem(li_renglon,'p_14',li_prestamos)
			case '15'
				dw_carga.SetItem(li_renglon,'p_15',li_prestamos)
			case '16'
				dw_carga.SetItem(li_renglon,'p_16',li_prestamos)
			case '17'
				dw_carga.SetItem(li_renglon,'p_17',li_prestamos)
			case '18'
				dw_carga.SetItem(li_renglon,'p_18',li_prestamos)
			case '19'
				dw_carga.SetItem(li_renglon,'p_19',li_prestamos)
			case else
				li_pres_despues=li_pres_despues+li_prestamos
				dw_carga.SetItem(li_renglon,'p_20',li_prestamos)
		end choose
		li_grupo_ant=li_grupo
	next

else
	dw_datos.DataObject='d_gen_tab_material_conteo_hora'
	dw_datos.settransobject(gtr_sumuia)
...
on w_gen_reporte_por_hora.create
...
on w_gen_reporte_por_hora.destroy
destroy(this.dw_mes)
...
integer taborder = 10
string title = "none"
string dataobject = "d_gen_rep_por_hora"
