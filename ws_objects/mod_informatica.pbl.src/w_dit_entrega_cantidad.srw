$PBExportHeader$w_dit_entrega_cantidad.srw
forward
global type w_dit_entrega_cantidad from window
end type
type cbx_merma from checkbox within w_dit_entrega_cantidad
end type
type cb_guardar from commandbutton within w_dit_entrega_cantidad
end type
type st_1 from statictext within w_dit_entrega_cantidad
end type
type sle_cantidad from singlelineedit within w_dit_entrega_cantidad
end type
end forward
...
global w_dit_entrega_cantidad w_dit_entrega_cantidad
...
on w_dit_entrega_cantidad.create
...
on w_dit_entrega_cantidad.destroy
