$PBExportHeader$w_dit_mat_insc.srw
...
forward
global type w_dit_mat_insc from w_gen_mat_insc
end type
end forward

global type w_dit_mat_insc from w_gen_mat_insc
end type
global w_dit_mat_insc w_dit_mat_insc

on w_dit_mat_insc.create
call super::create
end on

on w_dit_mat_insc.destroy
call super::destroy
end on
...
//	choose case li_tipo
//		case 1
//			dw_mat_cursos.dataobject= "d_dit_materias_insc"
...
//			
//		case 2
//			dw_mat_cursos.dataobject= "d_dit_materias_insc_p"
//			dw_mat_cursos.setTransObject(gtr_sumuia)
//			if dw_mat_cursos.Retrieve(ll_cuentaProf) = 0 then
...
event close;if ib_selecciona then	
	CloseWithReturn(w_dit_mat_insc,regreso)
end if
end event

type st_1 from w_gen_mat_insc`st_1 within w_dit_mat_insc
end type

type dw_mat_cursos from w_gen_mat_insc`dw_mat_cursos within w_dit_mat_insc
string dataobject = "d_dit_materias_insc_p"
end type
