$PBExportHeader$w_dit_prestamo_cantidad.srw
forward
global type w_dit_prestamo_cantidad from window
end type
type cb_guardar from commandbutton within w_dit_prestamo_cantidad
end type
type st_1 from statictext within w_dit_prestamo_cantidad
end type
type sle_cantidad from singlelineedit within w_dit_prestamo_cantidad
end type
end forward
...
global w_dit_prestamo_cantidad w_dit_prestamo_cantidad

type variables
integer ii_cantidad=0, ii_maximo
end variables

on w_dit_prestamo_cantidad.create
...
on w_dit_prestamo_cantidad.destroy
