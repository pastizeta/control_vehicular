$PBExportHeader$w_ing_pre_solicitud.srw
$PBExportComments$Muestra las presolicitudes capturadas para el alumno-profesor del departamento en cuestion
forward
global type w_ing_pre_solicitud from w_sheet
end type
type dw_mat_cursos from u_dw within w_ing_pre_solicitud
end type
end forward
...
global w_ing_pre_solicitud w_ing_pre_solicitud
...
on w_ing_pre_solicitud.destroy
call super::destroy
...
integer height = 752
integer taborder = 10
string dataobject = "d_ing_pre_solicitudes"
