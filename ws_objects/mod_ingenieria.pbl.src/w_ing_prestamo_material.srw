$PBExportHeader$w_ing_prestamo_material.srw
forward
global type w_ing_prestamo_material from window
end type
type ole_1 from olecustomcontrol within w_ing_prestamo_material
end type
type dw_tipo_usuario from datawindow within w_ing_prestamo_material
end type
type st_1 from statictext within w_ing_prestamo_material
end type
type tab_solicitud from tab within w_ing_prestamo_material
end type
...
type st_cod_uia from statictext within w_ing_prestamo_material
end type
type dw_reporte_mat from datawindow within w_ing_prestamo_material
end type
type sle_cod_agregar from singlelineedit within w_ing_prestamo_material
end type
type dw_matgrupo from u_basedw within w_ing_prestamo_material
end type
type dw_grupomat from u_basedw within w_ing_prestamo_material
end type
type st_grupo from statictext within w_ing_prestamo_material
end type
type cb_cerrar from commandbutton within w_ing_prestamo_material
end type
type dw_disponible from datawindow within w_ing_prestamo_material
end type
type cb_buscar from commandbutton within w_ing_prestamo_material
end type
type st_material from statictext within w_ing_prestamo_material
end type
type st_3 from statictext within w_ing_prestamo_material
end type
type st_2 from statictext within w_ing_prestamo_material
end type
type em_hora_final from editmask within w_ing_prestamo_material
end type
type em_fecha_final from editmask within w_ing_prestamo_material
end type
type st_final from statictext within w_ing_prestamo_material
end type
type em_hora_inicio from editmask within w_ing_prestamo_material
end type
type em_fecha_inicio from editmask within w_ing_prestamo_material
end type
type st_inicio from statictext within w_ing_prestamo_material
end type
type dw_solicitante from datawindow within w_ing_prestamo_material
end type
type cb_materias from commandbutton within w_ing_prestamo_material
end type
type dw_foto from datawindow within w_ing_prestamo_material
end type
type st_cuenta from statictext within w_ing_prestamo_material
end type
type sle_solicitante from singlelineedit within w_ing_prestamo_material
end type
type gb_busqueda from groupbox within w_ing_prestamo_material
end type
type gb_solicitud from groupbox within w_ing_prestamo_material
end type
type gb_material from groupbox within w_ing_prestamo_material
end type
type gb_seleccionado from groupbox within w_ing_prestamo_material
end type
type gb_disponible from groupbox within w_ing_prestamo_material
end type
type gb_solicitante from groupbox within w_ing_prestamo_material
end type
type dw_inventario_disponible from datawindow within w_ing_prestamo_material
end type
type cb_generar from commandbutton within w_ing_prestamo_material
end type
end forward
...
global w_ing_prestamo_material w_ing_prestamo_material
...
on w_ing_prestamo_material.create
...
on w_ing_prestamo_material.destroy
destroy(this.ole_1)
...
string binarykey = "w_ing_prestamo_material.win"
integer textsize = -10
integer weight = 400
...
if trim(this.text)<>'' then
	...
	if li_existe>0 then
		...
		if li_disponible>0 then
			...
			openwithparm(w_ing_entrega_cantidad,li_disponible)
...
03w_ing_prestamo_material.bin 

