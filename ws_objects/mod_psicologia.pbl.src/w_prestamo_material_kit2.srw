$PBExportHeader$w_prestamo_material_kit2.srw
forward
global type w_prestamo_material_kit2 from window
end type
type cb_agrega_kit from commandbutton within w_prestamo_material_kit2
end type
type dw_matgrupo from u_basedw within w_prestamo_material_kit2
end type
type dw_grupomat from u_basedw within w_prestamo_material_kit2
end type
type rb_kit from radiobutton within w_prestamo_material_kit2
end type
type rb_material from radiobutton within w_prestamo_material_kit2
end type
type cbx_espacio from checkbox within w_prestamo_material_kit2
end type
type cbx_venta from checkbox within w_prestamo_material_kit2
end type
type dw_tipo_usuario from datawindow within w_prestamo_material_kit2
end type
type st_1 from statictext within w_prestamo_material_kit2
end type
type ole_1 from olecustomcontrol within w_prestamo_material_kit2
end type
type tab_solicitud from tab within w_prestamo_material_kit2
end type
...
type st_cod_uia from statictext within w_prestamo_material_kit2
end type
type dw_reporte_mat from datawindow within w_prestamo_material_kit2
end type
type sle_cod_agregar from singlelineedit within w_prestamo_material_kit2
end type
type st_grupo from statictext within w_prestamo_material_kit2
end type
type cb_cerrar from commandbutton within w_prestamo_material_kit2
end type
type dw_disponible from datawindow within w_prestamo_material_kit2
end type
type cb_buscar from commandbutton within w_prestamo_material_kit2
end type
type st_material from statictext within w_prestamo_material_kit2
end type
type st_3 from statictext within w_prestamo_material_kit2
end type
type st_2 from statictext within w_prestamo_material_kit2
end type
type em_hora_final from editmask within w_prestamo_material_kit2
end type
type em_fecha_final from editmask within w_prestamo_material_kit2
end type
type st_final from statictext within w_prestamo_material_kit2
end type
type em_hora_inicio from editmask within w_prestamo_material_kit2
end type
type em_fecha_inicio from editmask within w_prestamo_material_kit2
end type
type st_inicio from statictext within w_prestamo_material_kit2
end type
type dw_solicitante from datawindow within w_prestamo_material_kit2
end type
type cb_materias from commandbutton within w_prestamo_material_kit2
end type
type dw_foto from datawindow within w_prestamo_material_kit2
end type
type st_cuenta from statictext within w_prestamo_material_kit2
end type
type sle_solicitante from singlelineedit within w_prestamo_material_kit2
end type
type gb_busqueda from groupbox within w_prestamo_material_kit2
end type
type gb_solicitud from groupbox within w_prestamo_material_kit2
end type
type gb_material from groupbox within w_prestamo_material_kit2
end type
type gb_seleccionado from groupbox within w_prestamo_material_kit2
end type
type gb_disponible from groupbox within w_prestamo_material_kit2
end type
type gb_solicitante from groupbox within w_prestamo_material_kit2
end type
type dw_inventario_disponible from datawindow within w_prestamo_material_kit2
end type
type cb_generar from commandbutton within w_prestamo_material_kit2
end type
end forward
...
string title = "Préstamo de Materiales V. 1.0"
...
global w_prestamo_material_kit2 w_prestamo_material_kit2
...
rb_kit.enabled=false
cb_agrega_kit.enabled=false
...
// se quita por indicacion de CD MX cph feb/2018
...
if ii_modal=1 then 
	//Venta
	this.title='Venta de Kits de Materiales' 
	...
	if ii_modal=0 then
		this.title='Préstamo de Kit de Materiales'
		idwc_grupomat.SetFilter('cvegrupo<>6')
	else
		this.title='Préstamo de Espacios' 
		idwc_grupomat.SetFilter('cvegrupo=6')
	end if
...
// se agrega la ventana _kits CPH feb 2018						
if ii_modal=0 then openwithparm(w_psi_solicitudes_hoy_kits,lstr_sol_material)
...
this.title='Préstamo de Kit de Materiales [Folio: '+string(p_folio)+']'
...
on w_prestamo_material_kit2.create
this.cb_agrega_kit=create cb_agrega_kit
...
this.Control[]={this.cb_agrega_kit,&
this.dw_matgrupo,&
this.dw_grupomat,&
this.rb_kit,&
this.rb_material,&
...
on w_prestamo_material_kit2.destroy
destroy(this.cb_agrega_kit)
...
string text = "Agregar Kit"
end type

event clicked;long ciclo_agrega, num_renglones

num_renglones=dw_disponible.rowcount()


//dw_disponible.setfocus()
//dw_disponible.setrow(1)
//dw_disponible.setcolumn("spre_materiales_nommaterial")
//dw_disponible.triggerevent(Clicked!)

//return

integer li_cantidad=0, li_disponible
long row


if (num_renglones>0) then
	for ciclo_agrega=1 to num_renglones
...
if row > 0 then
	...
	li_disponible=dw_disponible.GetItemNumber(row,'cantidad')
	...
	lstr_sol_material.cvedepto=dw_disponible.GetItemNumber(row,'spre_inventario_cvedepto')
	lstr_sol_material.cvearea=dw_disponible.GetItemNumber(row,'spre_inventario_cvearea')
	lstr_sol_material.cvegrupo=dw_disponible.GetItemNumber(row,'spre_inventario_cvegrupo')
	lstr_sol_material.cvematerial=dw_disponible.GetItemString(row,'spre_inventario_cvematerial')
	lstr_sol_material.num_serie=dw_disponible.GetItemString(row,'spre_inventario_num_serie')
	lstr_sol_material.nommaterial=dw_disponible.GetItemString(row,'spre_materiales_nommaterial')
	lstr_sol_material.prestamo_unitario=dw_disponible.GetItemNumber(row,'spre_inventario_prestamo_unitario')
	lstr_sol_material.cod_uia=dw_disponible.GetItemString(row,'spre_inventario_cod_uia')
	lstr_sol_material.status=0
	...
	lstr_sol_material.costo_mat=dw_disponible.GetItemDecimal(row,'spre_inventario_costo_mat')
	lstr_sol_material.tipo_unidad=dw_disponible.GetItemDecimal(row,'spre_inventario_tipo_unidad')
	lstr_sol_material.cantidad=li_cantidad
	lstr_sol_material.disponibilidad=dw_disponible.GetItemNumber(row,'disponibilidad')
...
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
string binarykey = "w_prestamo_material_kit2.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
string dataobject = "d_gen_prestamo_disponible_consu_kit"
boolean hscrollbar = true
boolean vscrollbar = true
borderstyle borderstyle = stylelowered!
end type
...
// se comenta por instrucciones de CD MX cph feb 2018
	/*
	if  ii_modal=0 then
...
0Fw_prestamo_material_kit2.bin 
...
1Fw_prestamo_material_kit2.bin 
