$PBExportHeader$w_psi_consulta_espacio.srw
forward
global type w_psi_consulta_espacio from window
end type
type cb_presolicitud from commandbutton within w_psi_consulta_espacio
end type
type cb_actualizar from commandbutton within w_psi_consulta_espacio
end type
type dw_exporta_dia from datawindow within w_psi_consulta_espacio
end type
type dw_ficha from datawindow within w_psi_consulta_espacio
end type
type dw_prestamos from datawindow within w_psi_consulta_espacio
end type
type dw_inventario from u_basedw within w_psi_consulta_espacio
end type
type cb_izquierda from commandbutton within w_psi_consulta_espacio
end type
type cb_derecha from commandbutton within w_psi_consulta_espacio
end type
type dw_salones_semana from datawindow within w_psi_consulta_espacio
end type
type dw_semana from datawindow within w_psi_consulta_espacio
end type
type dw_materiales from datawindow within w_psi_consulta_espacio
end type
type dw_dia from datawindow within w_psi_consulta_espacio
end type
end forward
...
global w_psi_consulta_espacio w_psi_consulta_espacio
...
on w_psi_consulta_espacio.create
...
on w_psi_consulta_espacio.destroy
...
event clicked;
opensheet(w_psi_presolicitudes_espacio,w_ppal,0,original!)
