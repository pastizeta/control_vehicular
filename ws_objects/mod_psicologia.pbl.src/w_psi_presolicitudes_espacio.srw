$PBExportHeader$w_psi_presolicitudes_espacio.srw
forward
global type w_psi_presolicitudes_espacio from window
end type
type cb_rechazar from commandbutton within w_psi_presolicitudes_espacio
end type
type cb_aprobar from commandbutton within w_psi_presolicitudes_espacio
end type
type cb_buscar from commandbutton within w_psi_presolicitudes_espacio
end type
type st_mensaje from statictext within w_psi_presolicitudes_espacio
end type
type dw_presolicitudes from datawindow within w_psi_presolicitudes_espacio
end type
type dw_csal_solicitudes_temporales from datawindow within w_psi_presolicitudes_espacio
end type
type dw_csal_solicitudes_permanente from datawindow within w_psi_presolicitudes_espacio
end type
end forward
...
global w_psi_presolicitudes_espacio w_psi_presolicitudes_espacio
...
integer li_status=0,li_tipo_usuario, li_consec=1, li_cvegrupo
string ls_observaciones='',ls_cvematerial,ls_num_serie,ls_sol_nombre
...
:ldt_fecha_final, :li_tipo_usuario, :ls_observaciones)
...
on w_psi_presolicitudes_espacio.create
...
on w_psi_presolicitudes_espacio.destroy
