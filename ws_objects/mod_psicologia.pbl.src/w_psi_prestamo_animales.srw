$PBExportHeader$w_psi_prestamo_animales.srw
forward
global type w_psi_prestamo_animales from window
end type
type uo_1 from uo_spre_anim_prestamos within w_psi_prestamo_animales
end type
type dw_tipo_usuario from datawindow within w_psi_prestamo_animales
end type
type ole_1 from olecustomcontrol within w_psi_prestamo_animales
end type
type dw_solicitante from datawindow within w_psi_prestamo_animales
end type
type cb_materias from commandbutton within w_psi_prestamo_animales
end type
type dw_foto from datawindow within w_psi_prestamo_animales
end type
type st_cuenta from statictext within w_psi_prestamo_animales
end type
type sle_solicitante from singlelineedit within w_psi_prestamo_animales
end type
type gb_busqueda from groupbox within w_psi_prestamo_animales
end type
type gb_solicitante from groupbox within w_psi_prestamo_animales
end type
end forward
...
global w_psi_prestamo_animales w_psi_prestamo_animales
...
on w_psi_prestamo_animales.create
...
on w_psi_prestamo_animales.destroy
destroy(this.uo_1)
...
string binarykey = "w_psi_prestamo_animales.win"
integer textsize = -10
integer weight = 400
