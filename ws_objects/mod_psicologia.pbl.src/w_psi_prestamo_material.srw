$PBExportHeader$w_psi_prestamo_material.srw
forward
global type w_psi_prestamo_material from window
end type
type cbx_espacio from checkbox within w_psi_prestamo_material
end type
type cbx_venta from checkbox within w_psi_prestamo_material
end type
type dw_tipo_usuario from datawindow within w_psi_prestamo_material
end type
type st_1 from statictext within w_psi_prestamo_material
end type
type ole_1 from olecustomcontrol within w_psi_prestamo_material
end type
type tab_solicitud from tab within w_psi_prestamo_material
end type
...
type st_cod_uia from statictext within w_psi_prestamo_material
end type
type dw_reporte_mat from datawindow within w_psi_prestamo_material
end type
type sle_cod_agregar from singlelineedit within w_psi_prestamo_material
end type
type dw_matgrupo from u_basedw within w_psi_prestamo_material
end type
type dw_grupomat from u_basedw within w_psi_prestamo_material
end type
type st_grupo from statictext within w_psi_prestamo_material
end type
type cb_cerrar from commandbutton within w_psi_prestamo_material
end type
type dw_disponible from datawindow within w_psi_prestamo_material
end type
type cb_buscar from commandbutton within w_psi_prestamo_material
end type
type st_material from statictext within w_psi_prestamo_material
end type
type st_3 from statictext within w_psi_prestamo_material
end type
type st_2 from statictext within w_psi_prestamo_material
end type
type em_hora_final from editmask within w_psi_prestamo_material
end type
type em_fecha_final from editmask within w_psi_prestamo_material
end type
type st_final from statictext within w_psi_prestamo_material
end type
type em_hora_inicio from editmask within w_psi_prestamo_material
end type
type em_fecha_inicio from editmask within w_psi_prestamo_material
end type
type st_inicio from statictext within w_psi_prestamo_material
end type
type dw_solicitante from datawindow within w_psi_prestamo_material
end type
type cb_materias from commandbutton within w_psi_prestamo_material
end type
type dw_foto from datawindow within w_psi_prestamo_material
end type
type st_cuenta from statictext within w_psi_prestamo_material
end type
type sle_solicitante from singlelineedit within w_psi_prestamo_material
end type
type gb_busqueda from groupbox within w_psi_prestamo_material
end type
type gb_solicitud from groupbox within w_psi_prestamo_material
end type
type gb_material from groupbox within w_psi_prestamo_material
end type
type gb_seleccionado from groupbox within w_psi_prestamo_material
end type
type gb_disponible from groupbox within w_psi_prestamo_material
end type
type gb_solicitante from groupbox within w_psi_prestamo_material
end type
type dw_inventario_disponible from datawindow within w_psi_prestamo_material
end type
type cb_generar from commandbutton within w_psi_prestamo_material
end type
end forward
...
global w_psi_prestamo_material w_psi_prestamo_material
...
public subroutine f_fecha_fija ();//em_fecha_inicio.text=string(f_calcula_fecha_habil(today(),0,gi_depto,gi_area))
//em_fecha_final.text=string(f_calcula_fecha_habil(today(),3,gi_depto,gi_area))
...
fecha_fin, tipo_solicitud, observaciones)
 
values
(:gi_depto, :ll_folio, :il_solicitante, :li_status, :ii_periodo, 0, :ldt_fecha_hoy, :ldt_fecha_inicio,
:ldt_fecha_final, :ii_tipo_usuario, :ls_observaciones)
...
if ii_modal=1 then 
	//Venta
	this.title='Venta de Materiales PSICOLOGÍA' 
	tab_solicitud.tabpage_solicitado.text='Venta ('+string(tab_solicitud.tabpage_solicitado.dw_solicitados.RowCount())+')'
	...
	if ii_modal=0 then
		this.title='Préstamo de Materiales PSICOLOGÍA'
		idwc_grupomat.SetFilter('cvegrupo<>6')
	else
		this.title='Préstamo de Espacios PSICOLOGÍA' 
		idwc_grupomat.SetFilter('cvegrupo=6')
	end if
...
long ll_tempo, ll_folio_renova
datetime ldt_fecha_inicio, ldt_fecha_final,ldt_ahora
long ll_folio=0, ll_presol=0, ll_presolr=0
...
if tab_solicitud.tabpage_solicitado.dw_solicitados.RowCount() > 0 then	
	...
	//Sí es una renovación manual hay que cerrar la anterior
	ll_presolr=tab_solicitud.tabpage_solicitado.dw_solicitados.GetItemNumber(1,'folio_presol')
	ll_folio_renova=f_valida_renovacion_manual(gi_depto,ll_presolr)

	if ll_folio_renova>0 then

		update dbo.spre_solicitud
		set status=1
		where cvedepto=:gi_depto
		and folio=:ll_folio_renova
		using gtr_sumuia;	

		update dbo.spre_sol_materiales
		set status=1,
		fecha_entrega=:ldt_ahora
		where cvedepto=:gi_depto and folio=:ll_folio_renova
		using gtr_sumuia;
		
		if gtr_sumuia.sqlcode<>0 then
			messagebox("Error al dar cierre de solicitud anterior"+string(gtr_sumuia.sqlcode), gtr_sumuia.SQLErrText)
			rollback using gtr_sumuia;
		else
			commit using gtr_sumuia;
		end if			
...
this.title='Préstamo de Materiales PSICOLOGÍA [Folio: '+string(p_folio)+']'
...
private subroutine f_agregar_material (str_sol_material pstr_sol_material, long p_folio_presol, integer p_rowdis);string ls_find=''
...
/*	end if*/
	...
	if ii_modal<>1 then tab_solicitud.tabpage_solicitado.text='Solicitado ('+string(tab_solicitud.tabpage_solicitado.dw_solicitados.RowCount())+')' else &
	tab_solicitud.tabpage_solicitado.text='Venta ('+string(tab_solicitud.tabpage_solicitado.dw_solicitados.RowCount())+')'
...
on w_psi_prestamo_material.create
this.cbx_espacio=create cbx_espacio
...
on w_psi_prestamo_material.destroy
destroy(this.cbx_espacio)
...
event clicked;integer li_venta=0, Net
string ls_cambio

if this.checked=true then 
	//Espacio
	ii_modal=2
	dw_disponible.dataobject = 'd_psi_prestamo_disponible_consu_esp'
	tab_solicitud.tabpage_solicitado.dw_solicitados.height = 365
else
	//Material
	ii_modal=0
	dw_disponible.dataobject = 'd_gen_prestamo_disponible_consu'
	tab_solicitud.tabpage_solicitado.dw_solicitados.height = 650
end if
...
if this.checked=true then 
	li_venta=1 
	ls_cambio='Préstamo a Venta'
else	
	li_venta=0
	ls_cambio='Venta a Préstamo'
end if

Net = messagebox("Atención",'Está por cambiar la pantalla de '+ls_cambio+'. ¿Desea continuar?', Question!, yesno!, 2)
if Net = 1 then 
	ii_modal=li_venta
	f_reset_solicitud()
	sle_solicitante.SetFocus()
else
	if li_venta=1 then this.checked=false else this.checked=true
end if
...
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
string binarykey = "w_psi_prestamo_material.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
	...
	choose case dwo.name
		...
		case 'cantidad'
			...
			if this.GetItemNumber(row,'tipo_unidad')=1 then
				...
				ls_find="spre_inventario_num_serie='"+this.GetItemString(row,'num_serie')+"' and marcado=0"
				li_existe=dw_inventario_disponible.Find(ls_find,1,dw_inventario_disponible.RowCount())
	
				if li_existe>0 then
			
					li_disponible=dw_inventario_disponible.GetItemNumber(li_existe,'cantidad') 
					...
					if li_disponible>1 then
						...
						openwithparm(w_psi_prestamo_cantidad,li_disponible)
	...
	for li_i=1 to tab_solicitud.tabpage_activo.dw_activos.RowCount()
		...
		if tab_solicitud.tabpage_activo.dw_activos.GetItemNumber(li_i,'cbox') = 1  then	
			...
			if ldt_ahora>ldt_fecha_final then
				...
				//Generar la multa automáticamente
				...
				messagebox("Atención",'La entrega extemporánea del material '+ls_num_serie+' genera una multa de $'+string(ldc_importe)+' pesos')
...
if trim(this.text)<>'' then
	...
	if li_existe>0 then
		...
		if li_disponible>0 then
			...
			openwithparm(w_psi_entrega_cantidad,li_disponible)
...
dw_matgrupo.Reset()
idwc_matgrupo.SetFilter('')
idwc_matgrupo.Filter()
idwc_matgrupo.Reset()
idwc_matgrupo.Retrieve(gi_depto,gi_area,il_cvegrupo)

if ii_modal=1 then
	idwc_matgrupo.SetFilter("disponibilidad = 1")
else
	idwc_matgrupo.SetFilter("disponibilidad = 0")
end if
idwc_matgrupo.Filter()
...
//	dw_inventario_disponible.Retrieve(gi_depto,gi_area,idt_fecha_inicio,idt_fecha_final)
	...
	if  ii_modal=0 then
		if is_solicitantenivel='P' then
			em_fecha_inicio.text=string(f_calcula_fecha_habil(today(),0,gi_depto,gi_area))
			em_fecha_final.text=string(f_calcula_fecha_habil(today(),5,gi_depto,gi_area))
		else
			em_fecha_inicio.text=string(f_calcula_fecha_habil(today(),0,gi_depto,gi_area))
			em_fecha_final.text=string(f_calcula_fecha_habil(today(),3,gi_depto,gi_area))
		end if
...
01w_psi_prestamo_material.bin 

11w_psi_prestamo_material.bin 
