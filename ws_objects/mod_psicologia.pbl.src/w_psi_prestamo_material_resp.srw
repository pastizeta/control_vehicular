$PBExportHeader$w_psi_prestamo_material_resp.srw
forward
global type w_psi_prestamo_material_resp from window
end type
type cbx_espacio from checkbox within w_psi_prestamo_material_resp
end type
type cbx_venta from checkbox within w_psi_prestamo_material_resp
end type
type dw_tipo_usuario from datawindow within w_psi_prestamo_material_resp
end type
type st_1 from statictext within w_psi_prestamo_material_resp
end type
type ole_1 from olecustomcontrol within w_psi_prestamo_material_resp
end type
type tab_solicitud from tab within w_psi_prestamo_material_resp
end type
...
type st_cod_uia from statictext within w_psi_prestamo_material_resp
end type
type dw_reporte_mat from datawindow within w_psi_prestamo_material_resp
end type
type sle_cod_agregar from singlelineedit within w_psi_prestamo_material_resp
end type
type cb_cerrar from commandbutton within w_psi_prestamo_material_resp
end type
type dw_solicitante from datawindow within w_psi_prestamo_material_resp
end type
type cb_materias from commandbutton within w_psi_prestamo_material_resp
end type
type dw_foto from datawindow within w_psi_prestamo_material_resp
end type
type st_cuenta from statictext within w_psi_prestamo_material_resp
end type
type sle_solicitante from singlelineedit within w_psi_prestamo_material_resp
end type
type gb_busqueda from groupbox within w_psi_prestamo_material_resp
end type
type gb_solicitante from groupbox within w_psi_prestamo_material_resp
end type
type dw_inventario_disponible from datawindow within w_psi_prestamo_material_resp
end type
type cb_generar from commandbutton within w_psi_prestamo_material_resp
end type
end forward
...
global w_psi_prestamo_material_resp w_psi_prestamo_material_resp
...
on w_psi_prestamo_material_resp.create
...
on w_psi_prestamo_material_resp.destroy
...
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
string binarykey = "w_psi_prestamo_material_resp.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
0Aw_psi_prestamo_material_resp.bin 
...
1Aw_psi_prestamo_material_resp.bin 
