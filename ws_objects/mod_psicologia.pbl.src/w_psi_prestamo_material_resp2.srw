$PBExportHeader$w_psi_prestamo_material_resp2.srw
forward
global type w_psi_prestamo_material_resp2 from window
end type
type cbx_espacio from checkbox within w_psi_prestamo_material_resp2
end type
type cbx_venta from checkbox within w_psi_prestamo_material_resp2
end type
type dw_tipo_usuario from datawindow within w_psi_prestamo_material_resp2
end type
type st_1 from statictext within w_psi_prestamo_material_resp2
end type
type ole_1 from olecustomcontrol within w_psi_prestamo_material_resp2
end type
type tab_solicitud from tab within w_psi_prestamo_material_resp2
end type
...
type st_cod_uia from statictext within w_psi_prestamo_material_resp2
end type
type dw_reporte_mat from datawindow within w_psi_prestamo_material_resp2
end type
type sle_cod_agregar from singlelineedit within w_psi_prestamo_material_resp2
end type
type st_grupo from statictext within w_psi_prestamo_material_resp2
end type
type cb_cerrar from commandbutton within w_psi_prestamo_material_resp2
end type
type cb_buscar from commandbutton within w_psi_prestamo_material_resp2
end type
type st_material from statictext within w_psi_prestamo_material_resp2
end type
type st_3 from statictext within w_psi_prestamo_material_resp2
end type
type st_2 from statictext within w_psi_prestamo_material_resp2
end type
type em_hora_final from editmask within w_psi_prestamo_material_resp2
end type
type em_fecha_final from editmask within w_psi_prestamo_material_resp2
end type
type st_final from statictext within w_psi_prestamo_material_resp2
end type
type em_hora_inicio from editmask within w_psi_prestamo_material_resp2
end type
type em_fecha_inicio from editmask within w_psi_prestamo_material_resp2
end type
type st_inicio from statictext within w_psi_prestamo_material_resp2
end type
type dw_solicitante from datawindow within w_psi_prestamo_material_resp2
end type
type cb_materias from commandbutton within w_psi_prestamo_material_resp2
end type
type dw_foto from datawindow within w_psi_prestamo_material_resp2
end type
type st_cuenta from statictext within w_psi_prestamo_material_resp2
end type
type sle_solicitante from singlelineedit within w_psi_prestamo_material_resp2
end type
type gb_busqueda from groupbox within w_psi_prestamo_material_resp2
end type
type gb_solicitud from groupbox within w_psi_prestamo_material_resp2
end type
type gb_material from groupbox within w_psi_prestamo_material_resp2
end type
type gb_solicitante from groupbox within w_psi_prestamo_material_resp2
end type
type dw_inventario_disponible from datawindow within w_psi_prestamo_material_resp2
end type
type cb_generar from commandbutton within w_psi_prestamo_material_resp2
end type
end forward
...
global w_psi_prestamo_material_resp2 w_psi_prestamo_material_resp2
...
on w_psi_prestamo_material_resp2.create
...
on w_psi_prestamo_material_resp2.destroy
...
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
string binarykey = "w_psi_prestamo_material_resp2.win"
integer textsize = -10
integer weight = 400
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
...
0Cw_psi_prestamo_material_resp2.bin 
...
1Cw_psi_prestamo_material_resp2.bin 
