$PBExportHeader$w_psi_solicitudes_espacios.srw
forward
global type w_psi_solicitudes_espacios from window
end type
type dw_solicitudes from datawindow within w_psi_solicitudes_espacios
end type
type gb_2 from groupbox within w_psi_solicitudes_espacios
end type
end forward
...
global w_psi_solicitudes_espacios w_psi_solicitudes_espacios
...
on w_psi_solicitudes_espacios.create
...
on w_psi_solicitudes_espacios.destroy
...
event close;CloseWithReturn(w_psi_solicitudes_espacios,istr_sol_material)
