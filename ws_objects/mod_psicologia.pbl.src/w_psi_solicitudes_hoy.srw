$PBExportHeader$w_psi_solicitudes_hoy.srw
forward
global type w_psi_solicitudes_hoy from window
end type
type dw_vencidas from datawindow within w_psi_solicitudes_hoy
end type
type dw_solicitudes from datawindow within w_psi_solicitudes_hoy
end type
type dw_presolicitudes from datawindow within w_psi_solicitudes_hoy
end type
type gb_1 from groupbox within w_psi_solicitudes_hoy
end type
type gb_3 from groupbox within w_psi_solicitudes_hoy
end type
type gb_2 from groupbox within w_psi_solicitudes_hoy
end type
end forward
...
global w_psi_solicitudes_hoy w_psi_solicitudes_hoy
...
on w_psi_solicitudes_hoy.create
...
on w_psi_solicitudes_hoy.destroy
...
event close;CloseWithReturn(w_psi_solicitudes_hoy,istr_sol_material)
