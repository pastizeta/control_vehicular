$PBExportHeader$w_psi_solicitudes_hoy_kits.srw
forward
global type w_psi_solicitudes_hoy_kits from window
end type
type dw_vencidas from datawindow within w_psi_solicitudes_hoy_kits
end type
type dw_solicitudes from datawindow within w_psi_solicitudes_hoy_kits
end type
type dw_presolicitudes from datawindow within w_psi_solicitudes_hoy_kits
end type
type gb_1 from groupbox within w_psi_solicitudes_hoy_kits
end type
type gb_3 from groupbox within w_psi_solicitudes_hoy_kits
end type
type gb_2 from groupbox within w_psi_solicitudes_hoy_kits
end type
end forward
...
global w_psi_solicitudes_hoy_kits w_psi_solicitudes_hoy_kits
...
on w_psi_solicitudes_hoy_kits.create
...
on w_psi_solicitudes_hoy_kits.destroy
...
//			if dw_solicitudes.GetItemNumber(li_i,'compute_renovable') =1 then 
//				cb_renovar.visible=true
//			end if
//		next
	end if		
...
event close;CloseWithReturn(w_psi_solicitudes_hoy_kits,istr_sol_material)
