...
type prototypes
// Sound
Function boolean sndPlaySoundA (string SoundName, uint Flags) Library "libkernel43.so" alias for "sndPlaySoundA;Ansi"
...
// Get module handle
Function long GetModuleHandleA(string modname) Library "libkernel43.so" alias for "GetModuleHandleA;Ansi"

// Window functions
Function int GetWindowTextA(long handle, ref string wintext, int length) Library "libuser43.so" alias for "GetWindowTextA;Ansi"
Function uint GetWindowsDirectoryA (ref string dirtext, uint textlen) library "libkernel43.so" alias for "GetWindowsDirectoryA;Ansi"
Function uint GetSystemDirectoryA (ref string dirtext, uint textlen) library "libkernel43.so" alias for "GetSystemDirectoryA;Ansi"
function uint FindWindowA( ref string lpClassName, ref string lpWindowName) Library "libuser43.so" alias for "FindWindowA;Ansi"


// User/computer information
Function boolean GetUserNameA(ref string  lpBuffer, ref int nSize) library "libkernel43.so" alias for "GetUserNameA;Ansi"
...
Function boolean GetTextExtentPoint32A(uint hdcr, string lpString, integer nCount, ref os_size size) Library "libgdi43.so" alias for "GetTextExtentPoint32A;Ansi"
