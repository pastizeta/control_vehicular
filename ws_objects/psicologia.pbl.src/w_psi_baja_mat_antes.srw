$PBExportHeader$w_psi_baja_mat_antes.srw
$PBExportComments$Ventana utilizada para capturar la baja del material
forward
global type w_psi_baja_mat_antes from window
end type
type dw_baja_mat from datawindow within w_psi_baja_mat_antes
end type
type cb_2 from commandbutton within w_psi_baja_mat_antes
end type
type cb_1 from commandbutton within w_psi_baja_mat_antes
end type
end forward
...
global w_psi_baja_mat_antes w_psi_baja_mat_antes

on w_psi_baja_mat_antes.create
...
on w_psi_baja_mat_antes.destroy
