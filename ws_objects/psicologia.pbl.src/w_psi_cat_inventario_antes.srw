$PBExportHeader$w_psi_cat_inventario_antes.srw
$PBExportComments$Ventana para captura del inventario
forward
global type w_psi_cat_inventario_antes from w_modelo_cap
end type
type cb_nuevo_mat from commandbutton within w_psi_cat_inventario_antes
end type
type cb_eliminar_mat from commandbutton within w_psi_cat_inventario_antes
end type
type dw_inv from datawindow within w_psi_cat_inventario_antes
end type
type rb_1 from radiobutton within w_psi_cat_inventario_antes
end type
type rb_2 from radiobutton within w_psi_cat_inventario_antes
end type
type cbx_1 from checkbox within w_psi_cat_inventario_antes
end type
type ln_1 from line within w_psi_cat_inventario_antes
end type
type ln_2 from line within w_psi_cat_inventario_antes
end type
end forward
...
global w_psi_cat_inventario_antes w_psi_cat_inventario_antes
...
on w_psi_cat_inventario_antes.create
int iCurrent
call super::create
...
on w_psi_cat_inventario_antes.destroy
call super::destroy
...
//Filtra el grupo de material por área
...
type dw_motivo from w_modelo_cap`dw_motivo within w_psi_cat_inventario_antes
integer x = 2830
integer y = 1140
end type

type cb_actualiza from w_modelo_cap`cb_actualiza within w_psi_cat_inventario_antes
integer x = 3259
integer y = 1944
integer width = 297
end type
...
type cb_cerrar from w_modelo_cap`cb_cerrar within w_psi_cat_inventario_antes
integer x = 3259
integer y = 2096
integer width = 297
end type

type cb_eliminar from w_modelo_cap`cb_eliminar within w_psi_cat_inventario_antes
integer x = 3657
integer y = 872
integer width = 297
end type

type cb_nuevo from w_modelo_cap`cb_nuevo within w_psi_cat_inventario_antes
integer x = 3657
integer y = 744
integer width = 297
end type
...
type dw_cap from w_modelo_cap`dw_cap within w_psi_cat_inventario_antes
integer x = 41
integer y = 124
integer width = 3515
integer height = 868
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_psi_inventario"
boolean hscrollbar = true
