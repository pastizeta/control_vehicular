$PBExportHeader$w_psi_multas_mat_antes.srw
$PBExportComments$Permite cargar el pago de  las multas del material
forward
global type w_psi_multas_mat_antes from w_sheet
end type
type st_5 from statictext within w_psi_multas_mat_antes
end type
type cbx_intercambio from checkbox within w_psi_multas_mat_antes
end type
type st_4 from statictext within w_psi_multas_mat_antes
end type
type st_3 from statictext within w_psi_multas_mat_antes
end type
type st_2 from statictext within w_psi_multas_mat_antes
end type
type st_1 from statictext within w_psi_multas_mat_antes
end type
type em_operacion from editmask within w_psi_multas_mat_antes
end type
type em_corte from editmask within w_psi_multas_mat_antes
end type
type em_caja from editmask within w_psi_multas_mat_antes
end type
type dw_solicitud from u_dw within w_psi_multas_mat_antes
end type
type sle_cuenta from singlelineedit within w_psi_multas_mat_antes
end type
type rb_2 from radiobutton within w_psi_multas_mat_antes
end type
type rb_1 from radiobutton within w_psi_multas_mat_antes
end type
type cb_cerrar from commandbutton within w_psi_multas_mat_antes
end type
type cb_actualiza from commandbutton within w_psi_multas_mat_antes
end type
type dw_interesado from u_dw within w_psi_multas_mat_antes
end type
type gb_1 from groupbox within w_psi_multas_mat_antes
end type
type gb_2 from groupbox within w_psi_multas_mat_antes
end type
end forward
...
global w_psi_multas_mat_antes w_psi_multas_mat_antes
...
on w_psi_multas_mat_antes.create
int iCurrent
call super::create
...
on w_psi_multas_mat_antes.destroy
call super::destroy
destroy(this.st_5)
...
integer height = 472
integer taborder = 30
string dataobject = "d_psi_mat_multa"
boolean border = false
end type
...
//						llFolio = dw_solicitud.getitemnumber(llRow,'spre_multas_folio')
						...
						WHERE ( dbo.spre_multas.folio = :llFolioDat ) 
						using gtr_sumuia;	
				end choose
			next
