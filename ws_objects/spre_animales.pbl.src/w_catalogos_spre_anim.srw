$PBExportHeader$w_catalogos_spre_anim.srw
forward
global type w_catalogos_spre_anim from window
end type
type st_2 from statictext within w_catalogos_spre_anim
end type
type tab_catalogos from tab within w_catalogos_spre_anim
end type
...
global w_catalogos_spre_anim w_catalogos_spre_anim
...
on w_catalogos_spre_anim.create
...
on w_catalogos_spre_anim.destroy
