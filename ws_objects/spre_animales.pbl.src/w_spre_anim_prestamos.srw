$PBExportHeader$w_spre_anim_prestamos.srw
forward
global type w_spre_anim_prestamos from window
end type
type cb_regresar2 from commandbutton within w_spre_anim_prestamos
end type
type cb_insertar_prestamo_un_animal from commandbutton within w_spre_anim_prestamos
end type
type dw_lista_materias from datawindow within w_spre_anim_prestamos
end type
type ddlb_hora_inicio from dropdownlistbox within w_spre_anim_prestamos
end type
type cb_2 from commandbutton within w_spre_anim_prestamos
end type
type st_5 from statictext within w_spre_anim_prestamos
end type
type dw_animales_prestados_x_fecha from datawindow within w_spre_anim_prestamos
end type
type sle_1 from singlelineedit within w_spre_anim_prestamos
end type
type ddlb_animales from dropdownlistbox within w_spre_anim_prestamos
end type
type dw_cat_animales_en_inventario from datawindow within w_spre_anim_prestamos
end type
type st_4 from statictext within w_spre_anim_prestamos
end type
type st_3 from statictext within w_spre_anim_prestamos
end type
type cb_fecha_final from commandbutton within w_spre_anim_prestamos
end type
type st_2 from statictext within w_spre_anim_prestamos
end type
type st_1 from statictext within w_spre_anim_prestamos
end type
type cb_fecha_inicio from commandbutton within w_spre_anim_prestamos
end type
type ddlb_hora_final from dropdownlistbox within w_spre_anim_prestamos
end type
type cb_busca_anim_disponibles from commandbutton within w_spre_anim_prestamos
end type
type mc_fecha_inicio from monthcalendar within w_spre_anim_prestamos
end type
type mc_fecha_final from monthcalendar within w_spre_anim_prestamos
end type
type cb_actualiza_anim_por_folio from commandbutton within w_spre_anim_prestamos
end type
type cb_actualiza3 from commandbutton within w_spre_anim_prestamos
end type
type cb_inserta from commandbutton within w_spre_anim_prestamos
end type
type cb_regresa1 from commandbutton within w_spre_anim_prestamos
end type
type cb_actualiza_prestamo from commandbutton within w_spre_anim_prestamos
end type
type dw_anim_lista_animales_x_folio_prestamo from datawindow within w_spre_anim_prestamos
end type
type dw_anim_prestamo_un_animal from datawindow within w_spre_anim_prestamos
end type
type dw_animales_disponibles from datawindow within w_spre_anim_prestamos
end type
type dw_anim_prestamo_solicitante from datawindow within w_spre_anim_prestamos
end type
type dw_anim_lista_prestamos_x_persona from datawindow within w_spre_anim_prestamos
end type
type dw_materias_para_prestamo from datawindow within w_spre_anim_prestamos
end type
end forward
...
global w_spre_anim_prestamos w_spre_anim_prestamos
...
on w_spre_anim_prestamos.create
...
on w_spre_anim_prestamos.destroy
...
//inicializa(id_solicitante,1,"Cesar Ponce","2191034","El profesor","El usuario",2,2,gtr_escolar) // alumnos
//messagebox("","aqui")
//inicializa(27199,2,"Cesar Ponce","2191034","El profesor","El usuario",2,2,gtr_escolar) // profesor
...
integer taborder = 40
boolean titlebar = true
string title = "Animales del préstamo"
