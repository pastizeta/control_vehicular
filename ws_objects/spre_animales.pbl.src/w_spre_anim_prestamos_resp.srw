$PBExportHeader$w_spre_anim_prestamos_resp.srw
forward
global type w_spre_anim_prestamos_resp from window
end type
type cb_regresar2 from commandbutton within w_spre_anim_prestamos_resp
end type
type cb_insertar_prestamo_un_animal from commandbutton within w_spre_anim_prestamos_resp
end type
type dw_lista_materias from datawindow within w_spre_anim_prestamos_resp
end type
type ddlb_hora_inicio from dropdownlistbox within w_spre_anim_prestamos_resp
end type
type cb_2 from commandbutton within w_spre_anim_prestamos_resp
end type
type st_5 from statictext within w_spre_anim_prestamos_resp
end type
type dw_animales_prestados_x_fecha from datawindow within w_spre_anim_prestamos_resp
end type
type sle_1 from singlelineedit within w_spre_anim_prestamos_resp
end type
type ddlb_animales from dropdownlistbox within w_spre_anim_prestamos_resp
end type
type dw_cat_animales_en_inventario from datawindow within w_spre_anim_prestamos_resp
end type
type st_4 from statictext within w_spre_anim_prestamos_resp
end type
type st_3 from statictext within w_spre_anim_prestamos_resp
end type
type cb_fecha_final from commandbutton within w_spre_anim_prestamos_resp
end type
type st_2 from statictext within w_spre_anim_prestamos_resp
end type
type st_1 from statictext within w_spre_anim_prestamos_resp
end type
type cb_fecha_inicio from commandbutton within w_spre_anim_prestamos_resp
end type
type ddlb_hora_final from dropdownlistbox within w_spre_anim_prestamos_resp
end type
type cb_busca_anim_disponibles from commandbutton within w_spre_anim_prestamos_resp
end type
type mc_fecha_inicio from monthcalendar within w_spre_anim_prestamos_resp
end type
type mc_fecha_final from monthcalendar within w_spre_anim_prestamos_resp
end type
type dw_animales_disponibles from datawindow within w_spre_anim_prestamos_resp
end type
type dw_anim_lista_prestamos_x_persona from datawindow within w_spre_anim_prestamos_resp
end type
type dw_anim_prestamo_solicitante from datawindow within w_spre_anim_prestamos_resp
end type
type cb_actualiza_prestamo from commandbutton within w_spre_anim_prestamos_resp
end type
type cb_actualiza_anim_por_folio from commandbutton within w_spre_anim_prestamos_resp
end type
type cb_regresa1 from commandbutton within w_spre_anim_prestamos_resp
end type
type dw_anim_prestamo_un_animal from datawindow within w_spre_anim_prestamos_resp
end type
type dw_materias_para_prestamo from datawindow within w_spre_anim_prestamos_resp
end type
type dw_anim_lista_animales_x_folio_prestamo from datawindow within w_spre_anim_prestamos_resp
end type
type cb_actualiza3 from commandbutton within w_spre_anim_prestamos_resp
end type
type cb_inserta from commandbutton within w_spre_anim_prestamos_resp
end type
end forward
...
string title = "Prestamo Animales"
...
global w_spre_anim_prestamos_resp w_spre_anim_prestamos_resp
...
public subroutine inicializa (long id_solicitante_param, integer tipo_solicitante_param, string nombre_solicitante_param, string telefono_solicitante_param, string nombre_profesor_param, string usuario_param, integer depto_param, integer area_param)
end prototypes
...
fecha_final=datetime(string(solo_fecha_final,"yyyy/mm/dd "+string(hora_final)+":00:00"))
...
if(tipo_solicitante=1) then
	conexion_prestamos_x_solicitante=gtr_escolar
else
	if(tipo_solicitante=2) then
		conexion_prestamos_x_solicitante=gtr_escolar	
	else
...
on w_spre_anim_prestamos_resp.create
...
on w_spre_anim_prestamos_resp.destroy
...
//inicializa(id_solicitante,1,"Cesar Ponce","2191034","El profesor","El usuario",2,2) // licenciatura

inicializa(27199,2,"Cesar Ponce","2191034","El profesor","El usuario",2,2) // profesor

//inicializa(10566,3,"Cesar Ponce","2191034","El profesor","El usuario",2,2) // intercambio
...
mc_fecha_inicio.getselecteddate(solo_fecha_inicio)
fecha_inicio=datetime(string(solo_fecha_inicio,"yyyy/mm/dd "+string(hora_inicio)+":00:00"))
...
if(dw_anim_lista_prestamos_x_persona.retrieve(id_solicitante)>1) then
	cb_insertar_prestamo_un_animal.enabled=true
end if
